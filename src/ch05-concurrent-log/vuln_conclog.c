 ...
 *   4. Reclaim the first free with a controlled object (e.g. msg_msg)
 *   5. Second free corrupts the freelist → overlapping objects
 *   6. Build arbitrary read/write primitive
 *   7. Full exploit chain: leak kernel base + overwrite creds/modprobe
 *
