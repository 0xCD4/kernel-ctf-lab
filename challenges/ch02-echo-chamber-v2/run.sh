...
#
# CH02 — Echo Chamber v2: stack overflow + info leak → kernel ROP
#
# Level 2: SMEP + KASLR (intended solve level for this challenge)
#
...
echo "[*] ch02-echo-chamber-v2 - Level $LEVEL - GDB :1234"
